...
var bingo = function() {
	...
	const bingoList = bingoLists[board];
	...
	var results = $("#results");
	results.append ('<a href="'+qSeed+qMode+qEx+qBoard+'"><img src="img/en.png" alt="English"></a><a href="'+qSeed+qMode+qEx+qBoard+'&lang=jp"><img src="img/jp.png" alt="Japanese"></a><p>SS Bingo <strong>v1</strong>&emsp;Seed: <strong>' +
